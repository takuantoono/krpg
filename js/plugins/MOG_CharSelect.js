...
Scene_CharSelect.prototype.loadFiles = function() {
	...
	for (var i = 0; i < membersTemp.length; i++) {
		 ...
		 if (enable) {
			 ...
			 if(fileName == "Actor_7") fileName="kactor1_1";
			 if(fileName == "Actor_8") fileName="kactor1_4";
			 if(fileName == "Actor_9") fileName="kactor1_5";
			 if(fileName == "Actor_10") fileName="kactor1_3";
			 if(fileName == "Actor_11") fileName="kactor1_0";
			 if(fileName == "Actor_12") fileName="kactor1_2";
			 if(fileName == "Actor_13") fileName="kactor4_1";
			 if(fileName == "Actor_14") fileName="kactor2_7";
			 if(fileName == "Actor_15") fileName="kactor2_5";
...
Scene_CharSelect.prototype.nextIndex2 = function(value) {
	if (this._phase[0] != 1) {return};
	SoundManager.playCursor();
    this._index = value;
	if (this._index >= this.maxActors()) {this._index = 0};
...
Scene_CharSelect.prototype.createParameters = function() {
	...
	this._parameters.bitmap.fontSize = Moghunter.charSel_parFontSize+9;
...
Scene_CharSelect.prototype.refreshParameters = function() {
	...
	this.drawPar(this.actor()._nickname,xr + 90,yr + 5);
	xr += 160;
	yr = yr + 58;
	var yr1 = yr +45;
	var yr2 = yr1 +47;
    if($dataActors[this.actor()._actorId].meta.HP==1)this.drawPar("★", xr, yr);
    if($dataActors[this.actor()._actorId].meta.HP==2)this.drawPar("★★", xr, yr);
    if($dataActors[this.actor()._actorId].meta.HP==3)this.drawPar("★★★", xr, yr);
    if($dataActors[this.actor()._actorId].meta.HP==4)this.drawPar("★★★★", xr, yr);
    if($dataActors[this.actor()._actorId].meta.HP==5)this.drawPar("★★★★★", xr, yr);
    if($dataActors[this.actor()._actorId].meta.MP==1)this.drawPar("★", xr, yr1);
    if($dataActors[this.actor()._actorId].meta.MP==2)this.drawPar("★★", xr, yr1);
    if($dataActors[this.actor()._actorId].meta.MP==3)this.drawPar("★★★", xr, yr1);
    if($dataActors[this.actor()._actorId].meta.MP==4)this.drawPar("★★★★", xr, yr1);
    if($dataActors[this.actor()._actorId].meta.SP==1)this.drawPar("★", xr, yr2);
    if($dataActors[this.actor()._actorId].meta.SP==2)this.drawPar("★★", xr, yr2);
    if($dataActors[this.actor()._actorId].meta.SP==3)this.drawPar("★★★", xr, yr2);
    if($dataActors[this.actor()._actorId].meta.SP==4)this.drawPar("★★★★", xr, yr2);
};
...
Scene_CharSelect.prototype.drawPar = function(par,x,y) {
	this._parameters.bitmap.drawText(String(par),x,y,150,32,"left");
};
