...
Game_Actor.prototype.canLearnSkill = function(skill, classId) {
    ...
    if (Imported.YEP_ClassChangeCore) {
      ...
      if (skill.learnRequireLevel > this.level) return false;
    }
...
Game_Actor.prototype.customLearnSkillJpCost = function(skill) {
    ...
    var cost = 0;
    var item = skill;
    var wcost = item.learnCostJp;
    var hcost = -1 * item.learnCostJp/2;
    var tcost = -1 * item.learnCostJp*1/3;
    var fcost = -1 * item.learnCostJp*1/5;
    var a = this;
    var b = this;
    var user = this;
    var target = this;
...
Window_SkillLearn.prototype.getEvalLine = function(evalLine) {
    ...
    var mcln = false;
    eval(evalLine);
    if(mclass)value=false;
    if(mmclass)value=false;
    if(user.isClass($dataClasses[3])||user.isClass($dataClasses[5])){
    if($gameSwitches.value(502)&&user.isStateAffected(25)&&monk1)value=true
    if($gameVariables.value(483)==2&&user.isStateAffected(25)&&monk1)value=true
    if($gameSwitches.value(502)&&user.isStateAffected(26)&&monk2)value=true
    if($gameVariables.value(483)==3&&user.isStateAffected(26)&&monk2)value=true
    if($gameSwitches.value(502)&&user.isStateAffected(27)&&monk3)value=true
    if($gameVariables.value(483)==4&&user.isStateAffected(27)&&monk3)value=true
    if($gameSwitches.value(502)&&user.isStateAffected(28)&&monk4)value=true
    if($gameVariables.value(483)==5&&user.isStateAffected(28)&&monk4)value=true
    if($gameSwitches.value(502)&&user.isStateAffected(29)&&monk5)value=true
    if($gameVariables.value(483)==10&&user.isStateAffected(29)&&monk5)value=true
    if($gameSwitches.value(502)&&user.isStateAffected(30)&&monk6)value=true
    if($gameVariables.value(483)==11&&user.isStateAffected(30)&&monk6)value=true
    if($gameSwitches.value(502)&&user.isStateAffected(31)&&monk7)value=true
    if($gameVariables.value(483)==6&&user.isStateAffected(31)&&monk7)value=true
    if($gameSwitches.value(502)&&user.isStateAffected(32)&&monk8)value=true
    if($gameVariables.value(483)==9&&user.isStateAffected(32)&&monk8)value=true
    }
    if(mclass){
    if(user.isClass($dataClasses[4])||user.isClass($dataClasses[6])){
    if($gameSwitches.value(502)||$gameVariables.value(483)==7)value=true
    }
    }
    if(mcl6||mcl7){
    if(user.isClass($dataClasses[6]))value=false
    }
    if(mcl7){
    if(user.isClass($dataClasses[5]))value=false
    }
    if(mcln){
    if(user.isClass($dataClasses[4]))value=false
    }
    if(mmclass){
    if(user.isClass($dataClasses[4])){
    if($gameSwitches.value(502)||$gameVariables.value(483)==7)value=true
    }
    }
    return value;
...
Window_SkillLearn.prototype.drawItem = function(index) {
    ...
    this.drawItemName(skill, rect.x, rect.y, rect.width-120);
...
Window_SkillLearnData.prototype.drawSkillData = function() {
    ...
    this.drawSkillCost(this._skill, 0, wy, 200);
...
Window_SkillLearnData.prototype.drawRequirements = function(wy) {
  ...
  Window_SkillLearnData.prototype.drawSkillCost = function(skill, x, y, width) {
    x += width;
    var count = 0;
    if($gameSwitches.value(209)){
      var cost = this._actor.getSkillUseCounter(skill.id)
      x = this.drawSkillCount(cost, x, y, count);
  ...
  Window_SkillLearnData.prototype.drawConjunction = function(x, y) {
    this.resetTextColor();
  ...
  Window_SkillLearnData.prototype.drawSkillTpCost = function(tpCost, x, y) {
  ...
  Window_SkillLearnData.prototype.drawSkillMpCost = function(mpCost, x, y, count) {
    if (count > 0) {
  ...
  Window_SkillLearnData.prototype.drawSkillCount = function(cost, x, y, count) {
    this.changeTextColor(this.textColor(0));
    x -= this.textWidth(cost);
    this.drawText(cost, x, y);
    return x;
  };
  
  Window_SkillLearnData.prototype.drawSkillHpCost = function(hpCost, x, y, count) {
    if (count > 0) {
      x = this.drawConjunction(x, y);
    }
  ...
  Window_SkillLearnData.prototype.drawSkillExpCost = function(expCost, x, y, count) {
    if (count > 0) {
      x = this.drawConjunction(x, y);
    }
  ...
  Window_SkillLearnData.prototype.drawSkillGoldCost = function(goldCost, x, y, count) {
    if (count > 0) {
      x = this.drawConjunction(x, y);
    }
  ...
  Window_SkillLearnData.prototype.drawSkillCostHeader = function(header, x, y) {
      if($gameSwitches.value(209)) return w
  ...
  Window_SkillLearnData.prototype.drawSkillCostFooter = function(footer, x, y) {
  ...
  Window_SkillLearnData.prototype.costWidth = function() {
