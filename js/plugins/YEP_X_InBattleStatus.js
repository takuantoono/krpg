...
//=============================================================================
 /*:
 * @plugindesc v1.01 (Requires YEP_BattleEngineCore.js) Adds a 'Status'
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(/<(?:HELP|DESCRIPTION|HELP DESCRIPTION)>/i)) {
        ...
        if (obj.description.length > descLength){
        obj.description += '\n';
...
Window_Command.prototype.addCommandAt2 = function(index, name, symbol, en, ext) {
...
Window_PartyCommand.prototype.makeInBattleStatusCommand = function() {
  ...
  this.addCommandAt2(index, text, 'inBattleStatus', true);
};
...
Window_InBattleStatus.prototype.refresh = function() {
  ...
  $gameSwitches._data[535]=true;
  this.drawActorSimpleStatus(this._battler, x2, 0, w);
  $gameSwitches._data[535]=false;
...
Scene_Battle.prototype.createPartyCommandWindow = function() {
  ...
  win.setHandler('formation', this.commandFormation.bind(this));
};
...
Scene_Battle.prototype.isAnyInputWindowActive = function() {
  ...
  if (this._fstatusWindow.active) return true;
